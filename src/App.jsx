          ...
          <section className="hero fade-in">
            ...
            <div className="hero-content">
              ...
              <div className="skills">
                <span className="skill" data-description="Expert • Production Architect • 6+ years"><img src="public/AWS.png" alt="AWS" style={{width: '16px', height: '16px', marginRight: '4px', verticalAlign: 'middle'}} /> AWS</span>
